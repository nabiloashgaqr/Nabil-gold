        ...
        try:
            ...
            if not gemini.enabled:
                ...
                review = gemini.summarize_learning({
                    ...
                    "day_of_week_breakdown": getattr(report, "day_of_week_breakdown", {}),
                    "rr_efficiency": getattr(report, "rr_efficiency", {}),
                    "news_proximity": getattr(report, "news_proximity", {}),
                    "regime_fit": getattr(report, "regime_fit", {}),
