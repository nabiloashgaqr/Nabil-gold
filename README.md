...
```text
1. cron-job.org يشغّل GitHub Action كل 10 دقائق طوال 24 ساعة في أيام العمل
...
| المهمة | الجدولة |
|---|---|
| التحليل والإشارات | كل 10 دقائق 24 ساعة خلال أيام العمل فقط، عبر cron-job.org (`workflow_dispatch`) |
...
#### Analysis — كل 10 دقائق 24 ساعة خلال أيام العمل فقط
