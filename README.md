...
حسب طلب التجربة الحالية، أبقينا فقط هذه الفلاتر في وضع الإشارات التجريبية:

- وقت التداول
- الأخبار الخطيرة الأساسية
- Duplicate Signal Filter

أما الفلاتر التالية يتم تجاوزها مؤقتًا في الوضع التجريبي للمراقبة فقط:

- RiskManagement rejection
- DynamicRisk confidence/quality thresholds
- Max open trades
- Max daily signals

> هذا الوضع ليس للاعتماد الحقيقي، بل لمراقبة خروج الإشارات وفهم أي وكيل يعطي إشارات أكثر.
