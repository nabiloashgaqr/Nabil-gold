# Gold AI Signals — XAU/USD Paper-Trading Bot

نظام آلي لتوليد إشارات ورقية للذهب **XAU/USD** وإدارتها عبر Telegram وSupabase. القرار النهائي مبني على **إجماع موزون من 5 وكلاء تحليل** مع فلاتر أخبار ومخاطر، بدون أي API قرار خارجي.
...
| آخر فحص | 337 اختبار ناجح تقريباً حسب آخر تشغيل محلي |
