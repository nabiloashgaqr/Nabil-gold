...
-- Entry 09:15 local (06:15 UTC) at 4060.95 · exit 16:25 UTC at 4090.00
...
--
-- Chart, 15-minute candle stamped Tue 04 Aug '26 16:15 (covers 16:15-16:30):
--     O 4063.788 · H 4091.377 · L 4062.100 · C 4078.512
--
-- Operator: entry in that window, exit 16:25 UTC.
--
...
--   verified   the exit. The 15m candle stamped 16:15 UTC printed a high of
--              4091.377, clearing TP2 at 4090.00, and its low of 4062.100
--              never came near the 4045.95 stop.
--   NOT seen   the entry. Both screenshots start at 12:00, so neither shows
--              06:15. The 4060.95 fill is taken on the operator's word, not
--              read off a chart. `max_adverse_excursion` is therefore
--              recorded as 0 and flagged as unobserved in signal_snapshot --
--              the low between 06:15 and 12:00 is simply unknown, and
--              inventing a number there would corrupt analyze_sl_floor,
...
--     candle high 4091.377 >= TP2 4090.00        -> target reached
--     candle low  4062.100 >  stop 4045.95       -> stop never threatened
--
...
INSERT INTO trades (
    ...
    '["Manual record of the PLAN UPDATE day map (A+ 97.8%, EXTREME_POI).",
      ...
      "15m candle 16:15 UTC: O 4063.788 H 4091.377 L 4062.100 C 4078.512.",
      "High 4091.377 cleared TP2 4090.00; the candle low 4062.100 never approached the 4045.95 stop.",
      "Exit 16:25 UTC at TP2 for +290.5 points (1.94R).",
      "Entry price is operator-stated: neither screenshot covers 06:15, so max_adverse_excursion is unobserved and stored as 0."]'::jsonb,
    '{
       "manual_entry": true,
       ...
       "source_candle_15m": {
         "time": "2026-08-04T16:15:00+00:00",
         "open": 4063.788, "high": 4091.377,
         "low": 4062.100, "close": 4078.512
       },
       "max_adverse_observed": false,
       "max_adverse_note": "Entry at 06:15 UTC is outside both screenshots (they start at 12:00). The low between entry and 12:00 was never seen, so max_adverse_excursion is 0 by absence of data, not by measurement. analyze_sl_floor reads this field -- treat this row as unjudgeable for the floor question.",
       "manual_note": "Entry time and price are operator-stated. The exit is chart-confirmed: the 16:15 candle high of 4091.377 cleared TP2 at 4090.00."
     }'::jsonb
);
